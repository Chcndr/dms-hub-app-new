  ...
  apiKeys: router({
    ...
    create: adminProcedure
      ...
      .mutation(async ({ input, ctx }) => {
        ...
        const prefix =
          input.environment === "production" ? "dms_live_" : "dms_test_";
    ...
    regenerate: adminProcedure
      ...
      .mutation(async ({ input }) => {
        ...
        // Genera nuova chiave
        const prefix =
          existing.environment === "production" ? "dms_live_" : "dms_test_";
  ...
  webhooks: router({
    ...
    test: adminProcedure
      ...
      .mutation(async ({ input }) => {
        ...
        const payload = input.testPayload || {
          event: "test",
  ...
  connections: router({
    ...
    list: adminProcedure.query(async () => {
      ...
      return await db
        ...
        .orderBy(desc(schema.externalConnections.updatedAt));
    }),
    ...
    update: adminProcedure
      ...
      .mutation(async ({ input }) => {
        ...
        await db
          .update(schema.externalConnections)
          .set({
    ...
    status: adminProcedure.query(async () => {
      ...
      return {
        ...
        nextSync: lastJob?.completedAt
          ? new Date(
              new Date(lastJob.completedAt).getTime() +
                (config?.frequency || 300) * 1000
            )
          : null,
      };
    }),
    ...
    updateConfig: adminProcedure
      ...
      .mutation(async ({ input, ctx }) => {
        ...
        const data: any = {
          ...
          modifiedBy: ctx.user?.uid || "system",
        };
        ...
        if (input.entities !== undefined)
          data.entities = JSON.stringify(input.entities);
