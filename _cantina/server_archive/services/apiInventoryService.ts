...
export function getAPIInventory(): APIEndpoint[] {
  return [
    ...
    // ============================================================================
    {
      ...
      requiresAuth: false,
      documentation:
        "Ritorna lo stato di salute del sistema (database, API, servizi esterni)",
    },
    {
      id: "auth.me",
      method: "GET",
    ...
    // ============================================================================
    {
      ...
      description:
        "Sincronizza utente Firebase con MioHub (crea/aggiorna profilo)",
      category: "system",
      status: "active",
      version: "2.0",
      requiresAuth: true,
      documentation:
        "Riceve un Firebase ID Token, lo verifica con Firebase Admin SDK, crea o aggiorna il profilo utente nel database MioHub e restituisce il profilo unificato con ruoli e permessi.",
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Verifica un Firebase ID Token e restituisce i dati decodificati (uid, email, provider). Utilizzato per validare sessioni esistenti.",
    },
    {
      id: "auth.firebase.me",
      method: "GET",
      ...
      requiresAuth: true,
      documentation:
        "Restituisce il profilo completo dell'utente autenticato tramite Firebase, inclusi ruoli e permessi MioHub.",
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Effettua il logout dell'utente Firebase, invalida la sessione lato server e rimuove i cookie.",
    },
    {
      id: "auth.login",
      method: "POST",
      ...
      requiresAuth: false,
      documentation:
        "Endpoint di login legacy per compatibilità. Accetta email e password, restituisce profilo utente.",
    },
    {
      id: "auth.register",
      method: "POST",
      ...
      requiresAuth: false,
      documentation:
        "Registra un nuovo utente nel sistema con email e password. Crea il profilo Firebase e il profilo MioHub.",
    },
    {
      id: "auth.config",
      method: "GET",
      ...
      requiresAuth: false,
      documentation:
        "Restituisce la configurazione Firebase pubblica (apiKey, authDomain, projectId) necessaria per inizializzare il client SDK.",
    },
    ...
    // ============================================================================
    {
      ...
      requiresAuth: true,
      documentation:
        "Ritorna statistiche aggregate su mercati, negozi, transazioni, check-in",
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Ritorna l'elenco completo dei mercati con statistiche aggregate",
    },
    {
      id: "analytics.shops",
      method: "GET",
      ...
      requiresAuth: true,
      documentation:
        "Ritorna l'elenco completo dei negozi con statistiche aggregate",
    },
    {
    ...
    // ============================================================================
    {
      ...
      requiresAuth: true,
      documentation:
        "Ritorna la configurazione del sistema di crediti di carbonio",
    },
    {
    ...
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Ritorna i rimborsi effettuati tramite crediti di carbonio",
    },
    ...
    // ============================================================================
    {
      ...
      requiresAuth: true,
      documentation:
        "Ritorna i log di sistema (API calls, database queries, errors)",
    },
    ...
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Sincronizza i dati TPER (fermate, linee, orari) dal portale Open Data di Bologna",
    },
    ...
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Importa automaticamente i dati del mercato da Slot Editor v3",
    },
    {
    ...
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Aggiorna lo stato di un posteggio (libero, occupato, riservato)",
    },
    {
    ...
    },
    {
      ...
      description:
        "Statistiche aggregate posteggi: totali, occupati, liberi, in assegnazione",
      category: "dms",
      status: "active",
      version: "1.0",
      requiresAuth: false,
      documentation:
        "Ritorna le statistiche aggregate di tutti i posteggi (REST endpoint su Hetzner)",
    },
    // DMS HUB - Vendors
    {
    ...
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Ritorna tutti i dettagli di un operatore con concessioni e wallet",
    ...
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Aggiorna lo stato di un task (pending, in_progress, completed, failed)",
    },
    {
    ...
    // ============================================================================
    {
      ...
      requiresAuth: true,
      documentation:
        "Ritorna l'inventario completo di tutte le API disponibili nel sistema",
    },
    {
      id: "guardian.logs",
      method: "GET",
      ...
      requiresAuth: true,
      documentation:
        "Ritorna i log centralizzati del sistema Guardian (API calls, errors, security)",
    },
    {
    ...
    // ============================================================================
    {
      ...
      requiresAuth: true,
      documentation:
        "Ritorna statistiche aggregate sui wallet: totale attivi, bloccati, saldo complessivo, avvisi PagoPA",
    },
    {
      id: "wallet.list",
      method: "GET",
      ...
      requiresAuth: true,
      documentation:
        "Ritorna l'elenco completo dei wallet operatori con saldo e stato",
    },
    {
      id: "wallet.getById",
      method: "GET",
      ...
      requiresAuth: true,
      documentation:
        "Ritorna i dettagli di un wallet specifico incluse le ultime transazioni",
    ...
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Modifica lo stato di un wallet (ATTIVO, BLOCCATO, SOSPESO)",
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Ritorna lo storico delle transazioni di un wallet (ricariche, decurtazioni)",
      testParams: { walletId: 1 },
    },
    {
      id: "wallet.ricarica",
      ...
      requiresAuth: true,
      documentation:
        "Effettua una ricarica manuale sul wallet (bonifico, contanti)",
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Effettua una decurtazione dal wallet (presenza mercato, sanzione)",
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Genera un avviso di pagamento PagoPA tramite E-FIL Plug&Pay per ricarica wallet",
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Avvia un pagamento spontaneo PagoPA con redirect al checkout",
    },
    {
    ...
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Verifica se il saldo wallet è sufficiente per effettuare una presenza al mercato",
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Ricerca i pagamenti PagoPA ricevuti in una data specifica per riconciliazione",
    },
    {
    ...
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Genera report aggregato dei wallet per un mercato specifico",
    },
    ...
    // ============================================================================
    {
      ...
      requiresAuth: true,
      documentation:
        "Ritorna l'elenco completo delle imprese registrate con filtri opzionali",
    },
    {
      id: "imprese.getById",
      method: "GET",
    ...
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Ritorna le qualificazioni associate a una specifica impresa",
      testParams: { id: 1 },
    },
    {
      id: "imprese.rating",
      ...
      requiresAuth: true,
      documentation:
        "Calcola e ritorna il rating di conformità (semaforo) per una impresa",
      testParams: { id: 1 },
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Avvia la migrazione dei dati imprese verso PDND (Piattaforma Digitale Nazionale Dati)",
    },
    ...
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Crea concessione con tutti i 60+ campi da SCIA, gestisce subingresso automatico",
    },
    {
    ...
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Aggiorna campi specifici: stato, scia_id, comune_rilascio, durata_anni",
      testParams: { id: 36 },
    },
    {
    ...
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Ritorna dettagli completi di una pratica SCIA con checks, eventi, documenti",
    ...
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Aggiorna campi pratica: concessione_id, stato, note, esito",
      testParams: { id: "a23ea538-f523-46c8-aa64-4729388deda5" },
    },
    {
    ...
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Carica un documento allegato alla pratica (multipart/form-data)",
      testParams: { id: "a23ea538-f523-46c8-aa64-4729388deda5" },
    },
    {
    ...
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Crea le tabelle wallets e wallet_transactions se non esistono",
    },
    {
      id: "wallets.deposit",
      method: "POST",
    ...
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Calcola il canone annuale basato su tariffa mercato e mq posteggio",
    },
    {
      id: "wallets.delete",
      method: "DELETE",
    ...
    // ============================================================================
    {
      ...
      requiresAuth: true,
      documentation:
        "Recupera il wallet TCC associato all'impresa con stato qualifiche per semaforo (verde=attivo, rosso=sospeso, grigio=nessuna qualifica)",
    ...
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Crea un nuovo wallet TCC per l'impresa. Lo stato iniziale dipende dalle qualifiche (active se qualificata, suspended altrimenti)",
      testParams: { impresaId: 38 },
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Verifica lo stato delle qualifiche dell'impresa (DURC, HACCP, etc.) per determinare il colore del semaforo wallet",
      testParams: { impresaId: 38 },
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Aggiorna manualmente lo stato del wallet impresa (active/suspended). Usato quando cambiano le qualifiche",
      testParams: { impresaId: 38 },
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Recupera lo storico delle transazioni TCC del wallet impresa (assegnazioni, riscatti, settlement)",
      testParams: { impresaId: 38 },
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Sincronizza lo stato del wallet con le qualifiche correnti dell'impresa. Aggiorna wallet_status in base a DURC, HACCP, etc.",
      testParams: { impresaId: 38 },
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Lista tutti i wallet TCC con stato impresa e qualifiche. Supporta filtro per status e hubId",
    },
    ...
    // ============================================================================
    {
      ...
      requiresAuth: true,
      documentation:
        "Ritorna il riepilogo delle scadenze canone con filtri per anno, mercato, tipo operatore (CONCESSION/SPUNTA/STRAORDINARIO)",
    ...
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Genera le 4 rate trimestrali del canone annuo per una concessione",
    ...
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Registra un pagamento straordinario per una singola rata specifica",
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Ritorna le ricariche effettuate sui wallet Spunta con filtro per mercato",
    ...
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Ritorna le imprese con concessioni e/o wallet Spunta per un mercato. Supporta filtro tipo_operatore (CONCESSION/SPUNTA/all)",
    ...
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Ritorna le impostazioni mora (percentuale, giorni grazia) per la PA",
    },
    {
    ...
    // ============================================================================
    {
      ...
      requiresAuth: true,
      documentation:
        "Ritorna le presenze registrate per un mercato con filtro tipo (CONCESSION/SPUNTA/STRAORDINARIO)",
    ...
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Registra presenza, calcola importo (Mq x €/mq/giorno), addebita wallet, aggiorna graduatoria",
      testParams: {
        market_id: 1,
        stall_id: 1,
        impresa_id: 1,
        wallet_id: 1,
        tipo_presenza: "SPUNTA",
      },
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Registra checkout e orario deposito rifiuti per una presenza",
    ...
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Ritorna la graduatoria con punteggi, presenze, assenze per tipo operatore",
    ...
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Permette di modificare presenze totali, punteggio, data prima presenza per caricare storico",
      testParams: {
        id: 1,
        presenze_totali: 100,
        punteggio: 100,
        data_prima_presenza: "2020-01-01",
      },
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Aggiorna contatore assenze e verifica soglia revoca (1/3 giorni anno)",
    ...
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Ricalcola le posizioni in graduatoria per mercato e tipo in base al punteggio",
    ...
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Crea un nuovo record in graduatoria per impresa/mercato/tipo",
    ...
    // ============================================================================
    {
      ...
      requiresAuth: false,
      documentation:
        "Raccoglie notifiche da domande_spunta e concessions filtrate per comune_id. Restituisce tipo_pratica, stato, impresa, comune.",
    ...
    },
    {
      ...
      description:
        "Registra orario deposito rifiuti per tutte le presenze attive",
      category: "wallet",
      status: "active",
      version: "4.6.1",
      requiresAuth: false,
      documentation:
        "Registra l'orario di deposito rifiuti per tutte le presenze attive del mercato nella data odierna. Simile al meccanismo chiudi-mercato.",
    ...
    },
    {
      ...
      requiresAuth: false,
      documentation:
        "Ritorna lo storico delle sessioni di mercato con filtro per comune_id. Limite default 1000 (rimosso limite 100 precedente).",
    ...
    // ============================================================================
    {
      ...
      requiresAuth: false,
      documentation:
        "Ritorna i dati del Comune (nome, provincia, indirizzo, PEC) e del Corpo di Polizia Municipale (comando, telefono, email) per la compilazione automatica dei verbali",
    },
    {
      ...
      requiresAuth: false,
      documentation:
        "Ritorna il catalogo completo delle infrazioni con codice, descrizione, importo minimo/massimo, testo di legge (D.Lgs. 114/98, L. 287/91, ecc.)",
    },
    {
      id: "verbali.create",
      method: "POST",
      ...
      requiresAuth: true,
      documentation:
        "Crea un nuovo verbale di contestazione conforme alla L. 689/81 con tutti i dati richiesti (agente, trasgressore, infrazione, importo, modalità pagamento)",
      testParams: {
        sanction_id: 1,
    ...
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Ritorna i dettagli completi di un verbale emesso, inclusi dati agente, trasgressore, infrazione, importi e scadenze",
    },
    {
      id: "verbali.pdf",
      method: "GET",
      ...
      requiresAuth: true,
      documentation:
        "Genera il PDF del verbale in formato conforme alla L. 689/81, pronto per la stampa e notifica",
    },
    {
      id: "verbali.invia",
      method: "POST",
      ...
      requiresAuth: true,
      documentation:
        "Invia la notifica del verbale all'impresa trasgressore via email/PEC con allegato PDF",
    },
    ...
    // ============================================================================
    {
      ...
      requiresAuth: true,
      documentation:
        "Ritorna le impostazioni degli orari (presenza, spazzatura, uscita) e le regole per verbali automatici di un mercato",
      testParams: { marketId: "1" },
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Crea o aggiorna le impostazioni degli orari e le regole per verbali automatici di un mercato",
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Ritorna la lista delle trasgressioni rilevate automaticamente con filtri per mercato, stato, tipo e data",
    ...
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Ritorna le trasgressioni in attesa di giustifica o con certificato da valutare",
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Permette all'impresa di inviare un certificato di giustifica per una trasgressione",
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Permette alla PM di approvare o rifiutare una giustifica inviata dall'impresa",
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Collega un verbale emesso a una trasgressione rilevata automaticamente",
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Ritorna statistiche aggregate sulle trasgressioni per dashboard",
    ...
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Esegue manualmente il CRON job per rilevamento trasgressioni e verifica scadenze giustifiche",
    },
    ...
    // ============================================================================
    {
      ...
      requiresAuth: false,
      documentation:
        "Ritorna la configurazione completa del sistema Gaming & Rewards per un comune specifico. Include parametri per segnalazioni civiche, mobilità sostenibile, cultura & turismo, acquisti locali e challenge.",
    ...
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Salva o aggiorna la configurazione del sistema Gaming & Rewards per un comune. Supporta UPSERT (insert or update).",
    },
    {
      ...
      requiresAuth: false,
      documentation:
        "Ritorna statistiche aggregate sui TCC per un comune: totale emessi, spesi, transazioni, CO2 risparmiata.",
      testParams: { comuneId: 1 },
    },
    {
      ...
      requiresAuth: false,
      documentation:
        "Ritorna i punti per la heatmap commerciale: negozi HUB con coordinate e aggregazione TCC (guadagnati/spesi/transazioni).",
      testParams: { comuneId: 1 },
    },
    ...
    // ============================================================================
    {
      ...
      requiresAuth: false,
      documentation:
        "Ritorna la configurazione Gaming & Rewards per un comune specifico. Parametri: comune_id",
    ...
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Crea una nuova configurazione Gaming & Rewards per un comune",
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Aggiorna la configurazione Gaming & Rewards esistente per un comune",
    },
    {
      ...
      requiresAuth: false,
      documentation:
        "Ritorna statistiche aggregate: TCC emessi, spesi, utenti attivi, CO2 risparmiata",
      testParams: { comune_id: 1 },
    },
    {
      ...
      requiresAuth: false,
      documentation:
        "Ritorna punti per heatmap transazioni TCC con coordinate e aggregazioni",
      testParams: { comune_id: 1 },
    },
    {
      ...
      requiresAuth: false,
      documentation:
        "Ritorna i top 5 negozi per TCC guadagnati con transazioni",
      testParams: { comune_id: 1 },
    },
    {
      ...
      requiresAuth: false,
      documentation:
        "Ritorna trend giornaliero TCC guadagnati/spesi e segnalazioni civiche",
      testParams: { comune_id: 1 },
    },
    ...
    // ============================================================================
    {
      ...
      requiresAuth: true,
      documentation:
        "Avvia il tracciamento di un percorso (bus, bici, piedi). Registra punto di partenza e tipo trasporto",
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Completa un percorso tracciato, calcola km e CO2 risparmiata, assegna TCC reward",
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Ritorna lo storico dei percorsi completati dall'utente con km, CO2 e TCC",
    },
    {
      ...
      requiresAuth: false,
      documentation:
        "Ritorna statistiche aggregate: km totali, CO2 risparmiata, percorsi completati",
      testParams: { comune_id: 1 },
    },
    {
      ...
      requiresAuth: false,
      documentation:
        "Ritorna fermate trasporto pubblico da GTFS con coordinate. Supporta filtro per lat/lng/radius",
    ...
    // ============================================================================
    {
      ...
      requiresAuth: true,
      documentation:
        "Registra un check-in in un luogo culturale (museo, monumento, ecc.) e assegna TCC reward",
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Ritorna lo storico delle visite culturali dell'utente con TCC guadagnati",
    },
    {
      ...
      requiresAuth: false,
      documentation:
        "Ritorna statistiche aggregate: visite totali, POI più visitati, TCC assegnati",
      testParams: { comune_id: 1 },
    },
    {
      ...
      requiresAuth: false,
      documentation:
        "Ritorna POI culturali da OpenStreetMap: musei, castelli, monumenti, teatri, siti archeologici. Supporta filtro per lat/lng/radius/type/region",
    ...
    // ============================================================================
    {
      ...
      requiresAuth: true,
      documentation:
        "Verifica stato della connessione PDND (mock o live), configurazione chiavi RSA e purpose ID",
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Ritorna i 3 e-Service esposti: dms-mercati, dms-concessioni, dms-operatori con stato di pubblicazione",
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Pubblica un e-Service su PDND Interop. Input: serviceId (dms-mercati|dms-concessioni|dms-operatori) + metadata",
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Testa la connettivita' verso PDND generando un voucher JWT e verificando la risposta",
    },
    {
      id: "pdnd.verificaCF",
      method: "GET",
      ...
      requiresAuth: true,
      documentation:
        "Verifica esistenza di un codice fiscale su ANPR tramite PDND. Ritorna dati anagrafici (nome, cognome, data nascita)",
    ...
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Lookup residenza da codice fiscale su ANPR via PDND. Ritorna indirizzo, CAP, comune, provincia",
      testParams: { codiceFiscale: "RSSMRA85M01H501Z" },
    },
    ...
    // ============================================================================
    {
      ...
      requiresAuth: true,
      documentation:
        "Invia una notifica a un cittadino tramite App IO usando template predefiniti (scadenza_concessione, avviso_pagamento, verbale_emesso, conferma_prenotazione)",
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Verifica se un cittadino ha App IO attiva e quali canali di notifica sono abilitati",
    ...
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Verifica stato della connessione App IO (mock o live), API key configurata, numero template disponibili",
    },
    {
      ...
      requiresAuth: true,
      documentation:
        "Ritorna i 4 template messaggi predefiniti: scadenza_concessione, avviso_pagamento, verbale_emesso, conferma_prenotazione",
    },
  ];
}
...
export function getAPIStats() {
  ...
  const byStatus = inventory.reduce(
    (acc, api) => {
...
export async function getDynamicEndpointCount(): Promise<number> {
  try {
    const response = await fetch(
      "https://api.mio-hub.me/api/dashboard/integrations/endpoint-count"
    );
