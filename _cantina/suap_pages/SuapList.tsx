            ...
            <table className="w-full caption-bottom text-sm text-left">
              <thead className="[&_tr]:border-b [&_tr]:border-[#1e293b]">
                <tr className="border-b border-[#1e293b] transition-colors hover:bg-[#1e293b]/50 data-[state=selected]:bg-[#1e293b]">
                  <th className="h-12 px-4 align-middle font-medium text-[#e8fbff]/60">
                    CUI
                  </th>
                  <th className="h-12 px-4 align-middle font-medium text-[#e8fbff]/60">
                    Tipo
              ...
              <tbody className="[&_tr:last-child]:border-0">
                {loading ? (
                  <tr>
                    <td
                      colSpan={7}
                      className="p-4 text-center text-[#e8fbff]/60"
                    >
                      Caricamento...
                    </td>
                  </tr>
                  ...
                  pratiche.map(p => (
                    <tr
                      key={p.id}
                      className="border-b border-[#1e293b] transition-colors hover:bg-[#1e293b]/50"
                    >
                      <td className="p-4 font-medium text-[#e8fbff]">
                        {p.cui}
                      </td>
                      ...
                      <td className="p-4 text-[#e8fbff]">
                        {new Date(p.data_presentazione).toLocaleDateString()}
                      </td>
                      <td className="p-4">
                        <Badge
                          variant="outline"
                          className={getStatusColor(p.stato)}
                        >
                          {p.stato}
                        </Badge>
                      </td>
