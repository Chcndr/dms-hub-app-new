...
export const vendorPresences = pgTable(
  "vendor_presences",
  {
    id: integer("id").generatedAlwaysAsIdentity().primaryKey(),
    vendorId: integer("vendor_id")
...
export const spuntisti = pgTable(
  "spuntisti",
  {
    id: integer("id").generatedAlwaysAsIdentity().primaryKey(),
    vendorId: integer("vendor_id")
...
export const violations = pgTable("violations", {
  id: integer("id").generatedAlwaysAsIdentity().primaryKey(),
  inspectionId: integer("inspection_id").references(
    () => inspectionsDetailed.id
  ),
  vendorId: integer("vendor_id")
    .references(() => vendors.id)
    .notNull(),
...
export const mioAgentLogs = pgTable(
  "mio_agent_logs",
  {
    id: integer("id").generatedAlwaysAsIdentity().primaryKey(),
...
export const agentMessages = pgTable("agent_messages", {
  ...
  messageType: varchar("message_type", { length: 50 })
    .default("text")
    .notNull(), // text, task, notification, error
...
export const operatoreWallet = pgTable(
  "operatore_wallet",
  {
    id: integer("id").generatedAlwaysAsIdentity().primaryKey(),
    impresaId: integer("impresa_id")
      .notNull()
      .references(() => vendors.id), // FK verso vendors (imprese/operatori)
...
export const walletTransazioni = pgTable(
  "wallet_transazioni",
  {
    id: integer("id").generatedAlwaysAsIdentity().primaryKey(),
    walletId: integer("wallet_id")
      .notNull()
      .references(() => operatoreWallet.id),
...
export const tariffePosteggio = pgTable(
  "tariffe_posteggio",
  {
    id: integer("id").generatedAlwaysAsIdentity().primaryKey(),
...
export const avvisiPagopa = pgTable(
  "avvisi_pagopa",
  {
    id: integer("id").generatedAlwaysAsIdentity().primaryKey(),
    walletId: integer("wallet_id")
...
export const autorizzazioni = pgTable("autorizzazioni", {
  ...
  vendorId: integer("vendor_id")
    .notNull()
    .references(() => vendors.id),
  numeroAutorizzazione: varchar("numero_autorizzazione", {
    length: 50,
  }).notNull(),
...
export const permissions = pgTable(
  ...
  table => ({
    moduleActionIdx: index("permissions_module_action_idx").on(
      table.module,
      table.action
    ),
    uniqueModuleAction: index("permissions_unique_idx").on(
      table.module,
      table.action
    ),
  })
...
export const rolePermissions = pgTable(
  ...
  table => ({
    ...
    uniqueRolePerm: index("role_permissions_unique_idx").on(
      table.roleId,
      table.permissionId
    ),
  })
...
export const complianceCertificates = pgTable(
  ...
  table => ({
    ...
    typeIdx: index("compliance_certificates_type_idx").on(
      table.certificateType
    ),
  })
);
export type ComplianceCertificate = typeof complianceCertificates.$inferSelect;
export type InsertComplianceCertificate =
  typeof complianceCertificates.$inferInsert;

// ============================================
// TABELLA 11: delegations (deleghe tra utenti)
// ============================================
export const securityDelegations = pgTable(
  "security_delegations",
  {
    id: integer("id").generatedAlwaysAsIdentity().primaryKey(),
    delegatorId: integer("delegator_id")
      .notNull()
      .references(() => users.id),
  ...
  table => ({
    delegatorIdx: index("security_delegations_delegator_idx").on(
      table.delegatorId
    ),
    delegateIdx: index("security_delegations_delegate_idx").on(
      table.delegateId
    ),
...
export const tccRateLimits = pgTable(
  "tcc_rate_limits",
  {
    id: integer("id").generatedAlwaysAsIdentity().primaryKey(),
    userId: integer("user_id")
  ...
  table => ({
    userActionIdx: index("tcc_rate_limits_user_action_idx").on(
      table.userId,
      table.actionType
    ),
...
export const tccFraudEvents = pgTable(
  "tcc_fraud_events",
  {
    id: integer("id").generatedAlwaysAsIdentity().primaryKey(),
    userId: integer("user_id").references(() => users.id),
...
export const tccIdempotencyKeys = pgTable(
...
export const tccDailyLimits = pgTable(
  "tcc_daily_limits",
  {
    id: integer("id").generatedAlwaysAsIdentity().primaryKey(),
    userId: integer("user_id")
  ...
  table => ({
    userDateIdx: index("tcc_daily_limits_user_date_idx").on(
      table.userId,
      table.date
    ),
  })
...
export const tccQrTokens = pgTable(
  "tcc_qr_tokens",
  {
    id: integer("id").generatedAlwaysAsIdentity().primaryKey(),
    userId: integer("user_id")
...
export const tccRewardsConfig = pgTable(
  "tcc_rewards_config",
  {
    ...
    highValueThresholdEur: integer("high_value_threshold_eur")
      .default(5000)
      .notNull(), // cents
    // Rewards TCC
    ...
    shoppingCashbackPercent: integer("shopping_cashback_percent")
      .default(5)
      .notNull(),
...
export const spidLevelEnum = pgEnum("spid_level", ["L1", "L2", "L3"]);

// ---- PDND e-Service ----
export const pdndEservices = pgTable(
  "pdnd_eservices",
  {
    id: integer("id").generatedAlwaysAsIdentity().primaryKey(),
...
// ---- PDND Voucher Log ----
export const pdndVouchers = pgTable(
  "pdnd_vouchers",
  {
    id: integer("id").generatedAlwaysAsIdentity().primaryKey(),
...
export const appIoMessages = pgTable(
  "app_io_messages",
  {
    id: integer("id").generatedAlwaysAsIdentity().primaryKey(),
...
// ---- ANPR Verifiche ----
export const anprVerifications = pgTable(
  "anpr_verifications",
  {
    id: integer("id").generatedAlwaysAsIdentity().primaryKey(),
    fiscalCode: varchar("fiscal_code", { length: 16 }).notNull(),
...
// ---- SSO Login Log ----
export const ssoLoginLogs = pgTable(
  "sso_login_logs",
  {
    id: integer("id").generatedAlwaysAsIdentity().primaryKey(),
    configurationId: integer("configuration_id").references(
      () => ssoConfigurations.id
    ),
    provider: ssoProviderEnum("provider").notNull(),
...
export const platformAuditTrail = pgTable(
