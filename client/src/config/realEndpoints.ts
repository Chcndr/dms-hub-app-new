...
export const marketsEndpoints: EndpointConfig[] = [
  {
    ...
    name: "Lista Mercati",
    description:
      "Ottieni la lista completa di tutti i mercati configurati nel sistema",
    category: "Mercati",
    exampleResponse: {
      success: true,
      data: [
    ...
    notes:
      "✅ FUNZIONANTE - Testato 28/11/2025 - Endpoint principale per ottenere tutti i mercati. Usato nella dashboard e nelle selezioni.",
  },
  {
    ...
    description:
      "Ottieni i dettagli completi di un mercato specifico tramite ID",
    category: "Mercati",
    exampleParams: { id: 1 },
    exampleResponse: {
      success: true,
    ...
    notes:
      "✅ FUNZIONANTE - Testato 28/11/2025 - Usato per visualizzare dettagli specifici di un mercato selezionato.",
  },
  {
    id: "markets-stalls",
    method: "GET",
    ...
    description:
      "Ottieni tutti i posteggi di un mercato specifico con stato e assegnazioni",
    category: "Mercati",
    exampleParams: { id: 1 },
    exampleResponse: {
      success: true,
    ...
    notes:
      "✅ FUNZIONANTE - Testato 28/11/2025 - Endpoint CRITICO usato da MarketMapComponent per colorare i posteggi sulla mappa. 160 posteggi Grosseto.",
  },
];
...
export const vendorsEndpoints: EndpointConfig[] = [
  {
    ...
    description:
      "Ottieni la lista completa di tutti i venditori/ambulanti registrati",
    category: "Operatori",
    exampleResponse: {
      success: true,
      data: [
    ...
    notes:
      "✅ FUNZIONANTE - Testato 28/11/2025 - Lista vuota (nessun vendor nel database Neon)",
  },
  {
    id: "vendors-create",
    method: "POST",
...
export const dmsHubEndpoints: EndpointConfig[] = [
  {
    ...
    notes:
      "❌ NON DEPLOYATO - 404 NOT FOUND - Backend Hetzner non ha commit fe1eab7",
  },
  {
...
export const concessionsEndpoints: EndpointConfig[] = [
  {
    ...
    description:
      "Ottieni tutte le concessioni attive (assegnazioni posteggi a venditori)",
  ...
  },
  {
    ...
    notes:
      "✅ FUNZIONANTE - Testato 04/01/2026 - Gestisce trasferimento wallet e cessazione vecchia concessione",
  },
  {
  ...
  },
  {
    ...
    description:
      "Aggiorna campi specifici: stato, scia_id, comune_rilascio, durata_anni, etc.",
    category: "Concessioni",
    exampleParams: { id: 36 },
...
export const suapEndpoints: EndpointConfig[] = [
  ...
  },
  {
    ...
    description:
      "Ottieni dettagli completi di una pratica SCIA con checks, eventi, documenti",
    category: "SUAP",
...
export const walletsEndpoints: EndpointConfig[] = [
  ...
  },
  {
    ...
    name: "Elimina Wallet",
    description:
      "Elimina un wallet e tutte le sue transazioni (registra evento in storico)",
    category: "Wallets",
    exampleParams: { id: 1 },
  ...
  // === STORICO WALLET (v3.34.0) ===
  {
    ...
    name: "Storico Wallet",
    description:
      "Ottieni lo storico di tutti gli eventi wallet (creazione, eliminazione, trasferimento)",
    category: "Wallets",
  ...
  // === CANONE UNICO (v3.35.0) ===
  {
    ...
    description:
      "Riepilogo scadenze canone con filtri per mercato, tipo operatore, impresa",
    category: "Canone Unico",
    exampleParams: {
      mercato_id: 1,
      tipo_operatore: "CONCESSIONE",
      stato: "NON_PAGATO",
    },
  ...
  },
  {
    ...
    description:
      "Genera le scadenze del canone annuo per tutti i posteggi attivi",
    category: "Canone Unico",
  ...
  },
  {
    ...
    description:
      "Genera avvisi di pagamento per un mercato/fiera straordinaria",
    category: "Canone Unico",
    exampleBody: {
      mercato_id: 1,
      descrizione: "Fiera Natale 2026",
      importo: 150,
  ...
  },
  {
    ...
    description:
      "Blocca o sblocca manualmente una concessione per mancato pagamento",
    category: "Canone Unico",
    exampleParams: { id: 1 },
  ...
  },
  {
    ...
    exampleParams: { comune_id: 1 },
    exampleBody: {
      blocco_automatico_pagamenti: true,
      giorni_tolleranza_blocco: 30,
    },
    notes: "✅ FUNZIONANTE - Aggiunto 14/01/2026 - v3.35.0",
  },
];
...
export const tariffsEndpoints: EndpointConfig[] = [
  ...
  },
  {
    ...
    category: "Tariffe",
    exampleBody: { market_id: 1, anno: 2026, tariffa_mq: 46.8 },
    notes: "✅ FUNZIONANTE - Testato 04/01/2026",
  },
];
...
export const gisEndpoints: EndpointConfig[] = [
  {
    ...
    description:
      "Ottieni il GeoJSON completo con geometrie di tutti i 160 posteggi del mercato",
    category: "GIS",
    exampleResponse: {
      success: true,
      data: {
    ...
    notes:
      "✅ FUNZIONANTE - Testato 28/11/2025 - Endpoint CRITICO per MarketMapComponent. Contiene le geometrie precise dei 160 posteggi Grosseto.",
  },
];
...
export const mobilityEndpoints: EndpointConfig[] = [
  {
    ...
    description:
      "Ottieni tutti i dati di mobilità salvati nel database (bus, tram, parcheggi)",
    category: "Mobilità",
    exampleResponse: {
      result: {
        data: [
    ...
    notes:
      "Usato da MobilityMap per visualizzare fermate su mappa. Legge da tabella mobility_data.",
  },
  {
    ...
    description:
      "Recupera le fermate bus TPER da API esterna Bologna Open Data (21,175 fermate)",
    category: "Mobilità",
    exampleResponse: {
      result: {
        data: {
    ...
    notes:
      "Chiama API esterna Bologna Open Data. NON salva nel database, solo visualizzazione.",
  },
  {
    ...
    description:
      "SINCRONIZZA i dati TPER nel database. Recupera fermate da API esterna e le salva in mobility_data.",
    category: "Mobilità",
    exampleBody: {},
    exampleResponse: {
      result: {
    ...
    notes:
      "⚠️ ENDPOINT CRITICO! Popola la tabella mobility_data. Chiamare PRIMA di visualizzare la mappa Centro Mobilità.",
  },
];
...
export const abacusSqlEndpoints: EndpointConfig[] = [
  {
    ...
    description:
      "Esegui query SQL read-only (SELECT) sul database Neon PostgreSQL",
    category: "Abacus SQL",
    exampleBody: {
    ...
    notes:
      "⚠️ Solo query SELECT permesse per sicurezza. Parametrizzate con $1, $2, etc.",
  },
  {
    id: "abacus-sql-count",
    method: "POST",
  ...
  },
  {
    ...
    notes:
      "Utile per esplorare la struttura del database prima di scrivere query.",
  },
];
...
export const abacusGithubEndpoints: EndpointConfig[] = [
  ...
  },
  {
    ...
    notes:
      "⚠️ Richiede SHA per aggiornamenti, omettere per creazione nuovi file.",
  },
];
...
export const tccWalletImpresaEndpoints: EndpointConfig[] = [
  {
    ...
    name: "Wallet Impresa",
    description:
      "Recupera il wallet TCC associato all'impresa con stato qualifiche",
    ...
    notes:
      "✅ v5.7.0 - Restituisce wallet, dati impresa e stato qualifiche per semaforo",
  },
  {
    ...
    notes:
      "✅ v5.7.0 - Crea wallet con stato basato su qualifiche (active/suspended)",
  },
  {
    ...
    description:
      "Verifica lo stato delle qualifiche dell'impresa per semaforo wallet",
    category: "TCC Wallet-Impresa",
    exampleParams: { impresaId: 3 },
    exampleResponse: {
      success: true,
    ...
    notes:
      "✅ v5.7.0 - Restituisce colore semaforo: green=qualificato, red=scaduto, gray=nessuna",
  },
  {
    ...
    description:
      "Aggiorna manualmente lo stato del wallet (active/suspended/blocked)",
    category: "TCC Wallet-Impresa",
    exampleParams: { impresaId: 3 },
    exampleBody: {
      status: "suspended",
...
export const firebaseAuthEndpoints: EndpointConfig[] = [
  {
    ...
    name: "Firebase Sync",
    description:
      "Sincronizza utente Firebase con MioHub (crea/aggiorna profilo dopo login social)",
    ...
    exampleResponse: {
      ...
      user: {
        ...
        email: "user@example.com",
        role: "citizen",
        permissions: ["view_markets", "view_wallet"],
      },
    },
  ...
  },
  {
    ...
    description:
      "Ottieni profilo utente Firebase corrente con ruoli e permessi MioHub",
    category: "Firebase Auth",
    requiresAuth: true,
    exampleResponse: {
      success: true,
  ...
  },
  {
    ...
    description:
      "Configurazione pubblica Firebase per inizializzare il client SDK",
    category: "Firebase Auth",
    requiresAuth: false,
    exampleResponse: {
...
export const integrations: IntegrationConfig[] = [
  ...
  },
  {
    ...
    description:
      "Sistema GIS per la gestione delle mappe dei mercati. Fornisce geometrie precise dei posteggi e dati geografici.",
    baseUrl: "https://api.mio-hub.me",
    status: "active",
    dataOwner: "Pepe GIS Editor",
    notes:
      "Master dei dati: Pepe GIS per geometrie e coordinate. File sorgente: editor-v3-full.json. Alimenta MarketMapComponent con 160 posteggi del Mercato Grosseto.",
    endpoints: ["/api/gis/market-map"],
  },
  {
    id: "mobility-tper",
    name: "Mobility / TPER",
    description:
      "Sistema di mobilità urbana e trasporto pubblico. Fornisce dati su fermate bus, tram e parcheggi.",
    baseUrl: MIHUB_API_BASE_URL,
    status: "active",
    dataOwner: "TPER / Comune",
    notes:
      "Integrato con API GTFS (MIHUB_API_BASE_URL). Dati reali TPER Bologna/Ferrara + Trenitalia + Tiemme importati nel database.",
    endpoints: [
      "/api/mobility/stops",
      "/api/mobility/lines",
  ...
  },
  {
    ...
    description:
      "Integrazione bidirezionale con MercaWeb (Abaco S.p.A.) per sincronizzazione anagrafiche mercati, ambulanti, piazzole, concessioni e presenze.",
    baseUrl: MIHUB_API_BASE_URL,
    status: "active",
    dataOwner: "Abaco S.p.A.",
    notes:
      "Integrazione attiva. Import anagrafiche via POST, export presenze via GET. Autenticazione tramite API Key (header X-MercaWeb-API-Key). Logica UPSERT basata su mercaweb_id.",
    endpoints: [
  ...
  },
  {
    ...
    description:
      "Sistema di autenticazione ibrido Firebase (Google, Apple, Email/Password) integrato con il backend MioHub per la gestione dei profili utente e dei ruoli.",
    baseUrl: "https://api.mio-hub.me",
    status: "active",
    dataOwner: "Firebase (Google Cloud) + MioHub",
    notes:
      "Progetto Firebase: dmshub-auth-2975e. Provider attivi: Google, Apple, Email/Password. Sincronizzazione automatica con profili MioHub. Fallback locale disponibile.",
    endpoints: [
  ...
  },
  {
    ...
    description:
      "Interoperabilità con la Piattaforma Digitale Nazionale Dati (PDND) di AgID/PagoPA per lo scambio sicuro di dati tra PA tramite e-service e voucher.",
    baseUrl: "https://api.pdnd.pagopa.it",
    status: "in_preparation",
    dataOwner: "AgID / PagoPA",
    notes:
      "In preparazione. Richiede accreditamento su PDND Interop, generazione keypair, registrazione e-service. Permetterà interrogazione ANPR, Registro Imprese, INPS per verifica automatica requisiti SCIA e regolarità imprese.",
    endpoints: [
