...
export function useAgentConversation(
  ...
  useEffect(() => {
    if (conversationQuery.data) {
      const rawMessages = Array.isArray(conversationQuery.data)
 ...
 */
export function mapAgentIdToBackend(
  frontendId: "mio" | "manus" | "abacus" | "zapier"
): AgentId {
