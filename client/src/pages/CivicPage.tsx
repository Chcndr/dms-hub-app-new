...
export default function CivicPage() {
      ...
      navigator.geolocation.getCurrentPosition(
        ...
        error => {
          ...
          if (error.code === error.PERMISSION_DENIED) {
            toast.error(
              "Permesso GPS negato. Abilita la localizzazione nelle impostazioni."
            );
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await authenticatedFetch(
        `${API_BASE_URL}/api/civic-reports`,
        {
          method: "POST",
          headers: {
      ...
      if (data.success) {
        ...
        setSubmitted(true);
        toast.success(
          `Segnalazione inviata! +${tccReward} crediti alla risoluzione`
        );
      } else {
        ...
        <Card className="max-w-lg w-full border-0 shadow-2xl overflow-hidden">
          ...
          <CardContent className="pt-8 pb-8 text-center space-y-6">
            ...
            <p className="text-muted-foreground text-lg">
              Grazie per il tuo contributo. Riceverai aggiornamenti sullo stato
              della segnalazione e
              <span className="font-bold text-green-600">
                {" "}
                +{tccReward} eco-crediti
              </span>{" "}
              quando sarà risolta.
            </p>
            <Link href="/">
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div
        className={`flex-1 overflow-y-auto ${isMobile ? "px-0" : "px-4 md:px-8 py-4"}`}
      >
        {/* Card principale - fullscreen su mobile */}
        <Card
          className={`border-0 shadow-xl overflow-hidden ${isMobile ? "rounded-none border-0" : "rounded-xl my-4"}`}
        >
          ...
          <div className="space-y-4 py-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Scegli il tipo di problema tra degrado, rifiuti,
                  illuminazione, sicurezza, buche o altro.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Fornisci una descrizione dettagliata per aiutare gli operatori
                  a intervenire.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  La posizione viene acquisita automaticamente all'apertura
                  della pagina.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Puoi allegare fino a 3 foto per documentare meglio il
                  problema.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Quando il problema sarà risolto, riceverai +{tccReward}{" "}
                  eco-crediti come premio.
                </p>
              </div>
            </div>
