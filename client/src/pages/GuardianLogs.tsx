...
export default function GuardianLogs() {
  ...
  const getRiskBadge = (risk?: string) => {
    ...
    return (
      <span
        className={`px-2 py-1 text-xs font-semibold rounded-full ${colors[risk as keyof typeof colors] || "bg-gray-100 text-gray-800"}`}
      >
        {risk}
      </span>
    );
    ...
    <div className="space-y-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-600">
                Storico chiamate API con controllo permessi
              </p>
            </div>
          </div>
          <button
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <p className="text-sm text-blue-800">
          ...
          log verranno scritti in tempo reale e caricati da MIHUB
        </p>
      </div>
    </div>
  );
