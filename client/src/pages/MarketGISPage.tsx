        ...
        <div className="bg-[#1a2332] border-b border-[#14b8a6]/30 px-4 py-3">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h1 className="text-lg font-semibold text-[#e8fbff]">
                  Pepe GIS - Mappa Mercato
                </h1>
                <p className="text-xs text-[#e8fbff]/70">
                  {selectedMarket
                    ? `${selectedMarket.name} (${selectedMarket.code})`
                    : "Vista Italia - Seleziona un mercato"}
                </p>
              </div>
            </div>
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <div className="text-xs text-[#e8fbff]/70">
                            {market.municipality} • {market.code}
                          </div>
                        </div>
