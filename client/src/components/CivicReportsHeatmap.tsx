...
function MapCenterUpdater({ reports, comuneId, selectedReport }: { reports: CivicReport[]; comuneId: number | null; selectedReport: { id: number; lat: number; lng: number; type: string } | null }) {
  const map = useMap();
      ...
      {error ? (
        ...
        <div className="h-[600px] rounded-lg overflow-hidden">
          ...
          >
            ...
            <MapCenterUpdater reports={reports} comuneId={currentComuneId} selectedReport={selectedReport} />
