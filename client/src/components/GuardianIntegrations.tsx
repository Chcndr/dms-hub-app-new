  ...
  const testEndpointMutation = useMutation({
    mutationFn: async (params: {
      ...
      const res = await authenticatedFetch(
        `${MIHUB_API_BASE_URL}/api/guardian/debug/testEndpoint`,
        {
          method: "POST",
      ...
      <div className="flex items-center justify-center py-12">
        <div className="text-center">
          ...
          <p className="text-red-400 font-semibold mb-2">
            Errore nel caricamento dell'inventario API
          </p>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-[#ec4899]">
                    {endpoints.length + (stats.active || 0)}
                  </p>
            ...
            <CardContent>
              <div className="space-y-4 max-h-[600px] overflow-y-auto">
                {Object.entries(endpointsByCategory).map(
                  ([category, categoryEndpoints]: [string, any]) => (
                    <div key={category}>
                      <div className="flex items-center gap-2 mb-2">
                        {getCategoryIcon(category)}
                        <h3 className="text-[#14b8a6] font-semibold uppercase text-sm">
                          {category}
                        </h3>
                      ...
                      <div className="space-y-2 ml-6">
                        {categoryEndpoints.map((endpoint: any) => (
                          ...
                          >
                            ...
                            <p className="text-[#e8fbff] text-sm font-mono">
                              {endpoint.path}
                            </p>
        ...
        <div className="space-y-4">
          {selectedEndpoint ? (
            <>
              <Card className="bg-[#1a2332] border-[#14b8a6]/30">
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <p className="text-[#e8fbff] font-mono text-sm">
                      {selectedEndpoint.id}
                    </p>
                  </div>
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      <p className="text-[#e8fbff] font-mono text-sm flex-1">
              ...
              {testResult && (
                <Card
                  className={`border-2 ${testResult.success ? "border-green-500/50 bg-green-500/10" : "border-red-500/50 bg-red-500/10"}`}
                >
                  <CardHeader>
                    <CardTitle className="text-[#e8fbff] flex items-center gap-2">
                      {testResult.success ? (
            ...
            <Card className="bg-[#1a2332] border-[#14b8a6]/30">
              <CardContent className="py-12 text-center">
                ...
                <p className="text-[#e8fbff]/60">
                  Seleziona un endpoint per vedere i dettagli e testarlo
                </p>
              </CardContent>
            </Card>
          )}
