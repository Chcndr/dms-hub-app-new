    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            <Zap
              className={`h-4 w-4 mr-1 ${autoRefresh ? "text-[#14b8a6]" : "text-gray-400"}`}
            />
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          >
            <CardHeader className="pb-2">
              <CardTitle className="text-[#e8fbff] text-sm">
                Stato Generale
              </CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="bg-gradient-to-br from-green-500/20 to-green-500/5 border-green-500/30">
            ...
            <CardContent>
              ...
              <p className="text-xs text-[#e8fbff]/60 mt-1">
                di {healthData.summary.total} totali
              </p>
            </CardContent>
          </Card>
          ...
          {error ? (
            <div className="text-center py-8 text-red-400">
              ...
              <p className="font-semibold mb-2">
                Impossibile contattare il sistema di monitoraggio
              </p>
                  ...
                  >
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          <h4 className="font-semibold text-[#e8fbff] text-sm">
                            {service.name}
                          </h4>
                      ...
                      {service.details && (
                        <div className="mt-2 text-xs text-[#e8fbff]/40">
                          ...
                          {service.details.uptime && (
                            <span>
                              Uptime: {Math.floor(service.details.uptime / 60)}m
                            </span>
                          )}
                        </div>
                      )}
