...
function StallCenterController({
  ...
  useEffect(() => {
    ...
    if (
      typeof stallCenter[0] !== "number" ||
      typeof stallCenter[1] !== "number"
    )
      return;
        ...
        >
                  ...
                  <Popup>
                    <div className="text-sm">
                      ...
                      <div className="text-gray-600">
                        Lat:{" "}
                        {typeof fixedCenter[0] === "number"
                          ? fixedCenter[0].toFixed(6)
                          : "-"}
                      </div>
                      <div className="text-gray-600">
                        Lng:{" "}
                        {typeof fixedCenter[1] === "number"
                          ? fixedCenter[1].toFixed(6)
                          : "-"}
                      </div>
                    </div>
                  </Popup>
          ...
          {mapData &&
            ...
            mapData.stalls_geojson.features.map((feature, idx) => {
              ...
              const displayStatus = normalizeStallStatus(
                dbStall?.status
              ) as string; // Normalizza EN→IT, null-safe
                    ...
                    <Popup className="stall-popup" minWidth={280}>
                      ...
                      (displayStatus === "libero" ||
                        ...
                        >
                          ...
                          <div className="p-4 space-y-4">
                            <p className="text-sm text-gray-300">
                              Conferma l'occupazione di questo posteggio per
                              registrare l'arrivo.
                            </p>
                            <button
                        ...
                        >
                          ...
                          <div className="p-4 space-y-4">
                            <p className="text-sm text-gray-300">
                              Conferma la liberazione di questo posteggio per
                              registrare l'uscita.
                            </p>
                            <button
                        ...
                        >
                          ...
                          <div className="p-4 space-y-4">
                            ...
                            {(() => {
                              ...
                              const safeArea =
                                typeof area === "number" && !isNaN(area)
                                  ? area
                                  : 0;
                              const safeCostPerSqm =
                                typeof costPerSqm === "number" &&
                                !isNaN(costPerSqm)
                                  ? costPerSqm
                                  : 0.9;
                              const canone = safeArea * safeCostPerSqm;
                              const safeCanone =
                                typeof canone === "number" && !isNaN(canone)
                                  ? canone
                                  : 0;
                                  ...
                                  <div className="flex justify-between items-center">
                                    ...
                                    <div className="text-right">
                                      <div className="font-bold text-xl text-blue-400">
                                        € {safeCanone.toFixed(2)}
                                      </div>
                                      <div className="text-[10px] text-gray-500">
                                        {safeArea.toFixed(2)} m² × €
                                        {safeCostPerSqm.toFixed(2)}/m²
                                      </div>
                                    </div>
                                  </div>
                                </div>
                            ...
                            {isSpuntaMode && displayStatus === "riservato" && (
                              <button
                                ...
                                onClick={async e => {
                                  e.stopPropagation();
                                  if (onConfirmAssignment && dbStall?.id)
