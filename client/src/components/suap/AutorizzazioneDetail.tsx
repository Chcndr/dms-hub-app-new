          ...
          <p className="text-gray-400">
            {autorizzazione.tipo === "A"
              ...
              : autorizzazione.tipo === "B"
                ? "TIPO B - ITINERANTE"
                : autorizzazione.tipo || "N/D"}{" "}
            -{" "}
            {autorizzazione.company_name ||
              autorizzazione.ragione_sociale ||
              "N/A"}{" "}
            (
            {autorizzazione.company_piva || autorizzazione.partita_iva || "N/A"}
            )
          </p>
        </div>
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <p className="text-[#e8fbff] font-medium">
                {autorizzazione.company_piva ||
                  autorizzazione.partita_iva ||
                  "-"}
              </p>
            </div>
            <div>
              ...
              <p className="text-[#e8fbff] font-medium">
                {autorizzazione.company_cf ||
                  autorizzazione.codice_fiscale ||
                  "-"}
              </p>
            </div>
            <div>
              ...
              <p className="text-[#e8fbff] font-medium">
                {autorizzazione.rappresentante_legale_nome ||
                  autorizzazione.rappresentante_nome ||
                  "-"}
              </p>
            </div>
            <div>
              ...
              <p className="text-[#e8fbff] font-medium">
                {autorizzazione.rappresentante_legale_cognome ||
                  autorizzazione.rappresentante_cognome ||
                  "-"}
              </p>
            </div>
            <div>
              ...
              <p className="text-[#e8fbff] font-medium">
                {autorizzazione.rappresentante_qualita ||
          ...
          <CardContent>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div>
                ...
                <p className="text-[#e8fbff] font-medium">
                  {autorizzazione.market_municipality || "-"}
                </p>
              </div>
              <div>
                <p className="text-xs text-gray-500 uppercase tracking-wide">
                ...
                <p className="text-[#e8fbff] font-medium">
                  {autorizzazione.posteggio_numero || "-"}
                </p>
              </div>
              <div>
                <p className="text-xs text-gray-500 uppercase tracking-wide">
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div>
              ...
              <p className="text-[#e8fbff] font-medium">
                {formatDate(autorizzazione.durc_data)}
              </p>
            </div>
            <div>
              <p className="text-xs text-gray-500 uppercase tracking-wide">
